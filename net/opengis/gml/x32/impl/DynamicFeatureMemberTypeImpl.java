 ...
 */
public class DynamicFeatureMemberTypeImpl extends net.opengis.gml.x32.impl.AbstractFeatureMemberTypeImpl implements net.opengis.gml.x32.DynamicFeatureMemberType
{
    private static final long serialVersionUID = 1L;
    
    public DynamicFeatureMemberTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public net.opengis.gml.x32.DynamicFeatureType[] getDynamicFeatureArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(DYNAMICFEATURE$1, targetList);
            net.opengis.gml.x32.DynamicFeatureType[] result = new net.opengis.gml.x32.DynamicFeatureType[targetList.size()];
     ...
     */
    public net.opengis.gml.x32.DynamicFeatureType getDynamicFeatureArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.DynamicFeatureType target = null;
            target = (net.opengis.gml.x32.DynamicFeatureType)get_store().find_element_user(DYNAMICFEATURE$1, i);
            if (target == null)
            {
     ...
     */
    public int sizeOfDynamicFeatureArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(DYNAMICFEATURE$1);
        }
    }
    
    /**
     * Sets array of all "DynamicFeature" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setDynamicFeatureArray(net.opengis.gml.x32.DynamicFeatureType[] dynamicFeatureArray)
    {
        check_orphaned();
        arraySetterHelper(dynamicFeatureArray, DYNAMICFEATURE$0, DYNAMICFEATURE$1);
    }
    
    /**
     * Sets ith "DynamicFeature" element
     */
    public void setDynamicFeatureArray(int i, net.opengis.gml.x32.DynamicFeatureType dynamicFeature)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public net.opengis.gml.x32.DynamicFeatureType insertNewDynamicFeature(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.DynamicFeatureType target = null;
            target = (net.opengis.gml.x32.DynamicFeatureType)get_store().insert_element_user(DYNAMICFEATURE$1, DYNAMICFEATURE$0, i);
            return target;
        }
    }
     ...
     */
    public void removeDynamicFeature(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DYNAMICFEATURE$1, i);
        }
    }
