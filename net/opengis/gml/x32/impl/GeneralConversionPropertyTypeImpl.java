 ...
 */
public class GeneralConversionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.GeneralConversionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public GeneralConversionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractGeneralConversion()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTGENERALCONVERSION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractGeneralConversion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTGENERALCONVERSION$1, 0);
        }
    }
