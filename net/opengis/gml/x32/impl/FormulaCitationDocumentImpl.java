 ...
 */
public class FormulaCitationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.FormulaCitationDocument
{
    private static final long serialVersionUID = 1L;
    
    public FormulaCitationDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     * This is a complex type.
     */
    public static class FormulaCitationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.FormulaCitationDocument.FormulaCitation
    {
        private static final long serialVersionUID = 1L;
        
        public FormulaCitationImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public boolean isSetCICitation()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(CICITATION$0) != 0;
            }
        }
         ...
         */
        public void unsetCICitation()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_element(CICITATION$0, 0);
            }
        }
