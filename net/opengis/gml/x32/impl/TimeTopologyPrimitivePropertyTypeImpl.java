 ...
 */
public class TimeTopologyPrimitivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.TimeTopologyPrimitivePropertyType
{
    ...
    public boolean isSetAbstractTimeTopologyPrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTTIMETOPOLOGYPRIMITIVE$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractTimeTopologyPrimitive()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTTIMETOPOLOGYPRIMITIVE$1, 0);
        }
    }
