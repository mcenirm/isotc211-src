 ...
 */
public class TopoPrimitiveMemberTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.TopoPrimitiveMemberType
{
    ...
    public boolean isSetAbstractTopoPrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTTOPOPRIMITIVE$1) != 0;
        }
    }
    ...
    public void unsetAbstractTopoPrimitive()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTTOPOPRIMITIVE$1, 0);
        }
    }
