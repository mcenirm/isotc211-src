 ...
 */
public class ProcedurePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.ProcedurePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public ProcedurePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractFeature()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTFEATURE$1) != 0;
        }
    }
