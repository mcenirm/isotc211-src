 ...
 */
public class NodeOrEdgePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.NodeOrEdgePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public NodeOrEdgePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public net.opengis.gml.x32.EdgeType getEdge()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.x32.EdgeType)get_store().find_element_user(EDGE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public net.opengis.gml.x32.EdgeType addNewEdge()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.EdgeType target = null;
            target = (net.opengis.gml.x32.EdgeType)get_store().add_element_user(EDGE$2);
            return target;
        }
    }
