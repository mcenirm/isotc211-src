 ...
 */
public class SurfacePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.SurfacePropertyType
{
    ...
    public boolean isSetAbstractSurface()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTSURFACE$1) != 0;
        }
    }
    ...
    public void unsetAbstractSurface()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTSURFACE$1, 0);
        }
    }
