 ...
 */
public class OperationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.OperationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public OperationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTOPERATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTOPERATION$1, 0);
        }
    }
