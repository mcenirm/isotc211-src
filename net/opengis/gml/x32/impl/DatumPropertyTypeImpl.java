 ...
 */
public class DatumPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.DatumPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DatumPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDATUM$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDatum()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDATUM$1, 0);
        }
    }
