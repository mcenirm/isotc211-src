 ...
 */
public class AbstractGeneralOperationParameterPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.AbstractGeneralOperationParameterPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public AbstractGeneralOperationParameterPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractGeneralOperationParameter()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTGENERALOPERATIONPARAMETER$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractGeneralOperationParameter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTGENERALOPERATIONPARAMETER$1, 0);
        }
    }
