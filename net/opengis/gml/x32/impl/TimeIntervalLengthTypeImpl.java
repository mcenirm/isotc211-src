 ...
 */
public class TimeIntervalLengthTypeImpl extends org.apache.xmlbeans.impl.values.JavaDecimalHolderEx implements net.opengis.gml.x32.TimeIntervalLengthType
{
     ...
     */
    public net.opengis.gml.x32.TimeUnitType xgetUnit()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.TimeUnitType target = null;
            target = (net.opengis.gml.x32.TimeUnitType)get_store().find_attribute_user(UNIT$0);
            return target;
        }
    }
     ...
     */
    public void xsetUnit(net.opengis.gml.x32.TimeUnitType unit)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (net.opengis.gml.x32.TimeUnitType)get_store().add_attribute_user(UNIT$0);
            }
            target.set(unit);
        }
    }
