 ...
 */
public class CoordinateSystemPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.CoordinateSystemPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CoordinateSystemPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractCoordinateSystem()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTCOORDINATESYSTEM$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractCoordinateSystem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTCOORDINATESYSTEM$1, 0);
        }
    }
