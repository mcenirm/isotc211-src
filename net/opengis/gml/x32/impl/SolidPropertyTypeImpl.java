 ...
 */
public class SolidPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.SolidPropertyType
{
    ...
    public boolean isSetAbstractSolid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTSOLID$1) != 0;
        }
    }
    ...
    public void unsetAbstractSolid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTSOLID$1, 0);
        }
    }
