 ...
 */
public class ArcStringByBulgeTypeImpl extends net.opengis.gml.x32.impl.AbstractCurveSegmentTypeImpl implements net.opengis.gml.x32.ArcStringByBulgeType
{
    ...
    public net.opengis.gml.x32.VectorType getNormalArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.x32.VectorType)get_store().find_element_user(NORMAL$12, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public net.opengis.gml.x32.VectorType insertNewNormal(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.VectorType target = null;
            target = (net.opengis.gml.x32.VectorType)get_store().insert_element_user(NORMAL$12, i);
            return target;
        }
    }
    ...
    public net.opengis.gml.x32.VectorType addNewNormal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.VectorType target = null;
            target = (net.opengis.gml.x32.VectorType)get_store().add_element_user(NORMAL$12);
            return target;
        }
    }
