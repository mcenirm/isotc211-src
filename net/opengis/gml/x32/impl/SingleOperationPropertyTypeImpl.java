 ...
 */
public class SingleOperationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.SingleOperationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public SingleOperationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractSingleOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTSINGLEOPERATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractSingleOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTSINGLEOPERATION$1, 0);
        }
    }
