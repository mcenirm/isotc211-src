 ...
 */
public class CubicSplineTypeImpl extends net.opengis.gml.x32.impl.AbstractCurveSegmentTypeImpl implements net.opengis.gml.x32.CubicSplineType
{
    ...
    private static final javax.xml.namespace.QName VECTORATSTART$10 = 
        new javax.xml.namespace.QName("http://www.opengis.net/gml/3.2", "vectorAtStart");
    private static final javax.xml.namespace.QName VECTORATEND$12 = 
        new javax.xml.namespace.QName("http://www.opengis.net/gml/3.2", "vectorAtEnd");
     ...
     */
    public net.opengis.gml.x32.VectorType getVectorAtStart()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.VectorType target = null;
            target = (net.opengis.gml.x32.VectorType)get_store().find_element_user(VECTORATSTART$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setVectorAtStart(net.opengis.gml.x32.VectorType vectorAtStart)
    {
     ...
     */
    public net.opengis.gml.x32.VectorType addNewVectorAtStart()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.VectorType target = null;
            target = (net.opengis.gml.x32.VectorType)get_store().add_element_user(VECTORATSTART$10);
            return target;
        }
    }
     ...
     */
    public net.opengis.gml.x32.VectorType getVectorAtEnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.VectorType target = null;
            target = (net.opengis.gml.x32.VectorType)get_store().find_element_user(VECTORATEND$12, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setVectorAtEnd(net.opengis.gml.x32.VectorType vectorAtEnd)
    {
     ...
     */
    public net.opengis.gml.x32.VectorType addNewVectorAtEnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.VectorType target = null;
            target = (net.opengis.gml.x32.VectorType)get_store().add_element_user(VECTORATEND$12);
            return target;
        }
    }
