 ...
 */
public class GeneralTransformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.GeneralTransformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public GeneralTransformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractGeneralTransformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTGENERALTRANSFORMATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractGeneralTransformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTGENERALTRANSFORMATION$1, 0);
        }
    }
