 ...
 */
public class AffineCSPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.AffineCSPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public AffineCSPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAffineCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(AFFINECS$0) != 0;
        }
    }
    ...
    public void unsetAffineCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(AFFINECS$0, 0);
        }
    }
