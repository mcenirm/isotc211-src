 ...
 */
public class LocationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.LocationPropertyType
{
    ...
    public net.opengis.gml.x32.CodeType getLocationKeyWord()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.x32.CodeType)get_store().find_element_user(LOCATIONKEYWORD$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public net.opengis.gml.x32.CodeType addNewLocationKeyWord()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.CodeType target = null;
            target = (net.opengis.gml.x32.CodeType)get_store().add_element_user(LOCATIONKEYWORD$2);
            return target;
        }
    }
    ...
    public net.opengis.gml.x32.StringOrRefType getLocationString()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.x32.StringOrRefType)get_store().find_element_user(LOCATIONSTRING$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public net.opengis.gml.x32.StringOrRefType addNewLocationString()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.StringOrRefType target = null;
            target = (net.opengis.gml.x32.StringOrRefType)get_store().add_element_user(LOCATIONSTRING$4);
            return target;
        }
    }
