 ...
 */
public class DomainOfValidityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.DomainOfValidityDocument
{
    private static final long serialVersionUID = 1L;
    
    public DomainOfValidityDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     * This is a complex type.
     */
    public static class DomainOfValidityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.DomainOfValidityDocument.DomainOfValidity
    {
        private static final long serialVersionUID = 1L;
        
        public DomainOfValidityImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public boolean isSetEXExtent()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(EXEXTENT$0) != 0;
            }
        }
         ...
         */
        public void unsetEXExtent()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_element(EXEXTENT$0, 0);
            }
        }
