 ...
 */
public class FaceOrTopoSolidPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.FaceOrTopoSolidPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public FaceOrTopoSolidPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName OWNS$22 = 
    ...
    public net.opengis.gml.x32.TopoSolidType getTopoSolid()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.x32.TopoSolidType)get_store().find_element_user(TOPOSOLID$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public net.opengis.gml.x32.TopoSolidType addNewTopoSolid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.TopoSolidType target = null;
            target = (net.opengis.gml.x32.TopoSolidType)get_store().add_element_user(TOPOSOLID$2);
            return target;
        }
    }
    ...
    public boolean getOwns()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(OWNS$22);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(OWNS$22);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetOwns()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(OWNS$22);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(OWNS$22);
            }
            return target;
        }
    }
    ...
    public boolean isSetOwns()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(OWNS$22) != null;
        }
    }
    ...
    public void setOwns(boolean owns)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(OWNS$22);
            }
    ...
    public void xsetOwns(org.apache.xmlbeans.XmlBoolean owns)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(OWNS$22);
            }
            target.set(owns);
        }
    }
    ...
    public void unsetOwns()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(OWNS$22);
        }
    }
}
