 ...
 */
public class TimePositionTypeImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements net.opengis.gml.x32.TimePositionType, net.opengis.gml.x32.CalDate, org.apache.xmlbeans.XmlTime, org.apache.xmlbeans.XmlDateTime, org.apache.xmlbeans.XmlAnyURI, org.apache.xmlbeans.XmlDecimal
{
     ...
     */
    public net.opengis.gml.x32.TimeIndeterminateValueType.Enum getIndeterminatePosition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (net.opengis.gml.x32.TimeIndeterminateValueType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public net.opengis.gml.x32.TimeIndeterminateValueType xgetIndeterminatePosition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.x32.TimeIndeterminateValueType target = null;
            target = (net.opengis.gml.x32.TimeIndeterminateValueType)get_store().find_attribute_user(INDETERMINATEPOSITION$4);
            return target;
        }
    }
     ...
     */
    public void setIndeterminatePosition(net.opengis.gml.x32.TimeIndeterminateValueType.Enum indeterminatePosition)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetIndeterminatePosition(net.opengis.gml.x32.TimeIndeterminateValueType indeterminatePosition)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (net.opengis.gml.x32.TimeIndeterminateValueType)get_store().add_attribute_user(INDETERMINATEPOSITION$4);
            }
