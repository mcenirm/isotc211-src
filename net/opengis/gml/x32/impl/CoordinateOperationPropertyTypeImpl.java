 ...
 */
public class CoordinateOperationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.CoordinateOperationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CoordinateOperationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractCoordinateOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTCOORDINATEOPERATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractCoordinateOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTCOORDINATEOPERATION$1, 0);
        }
    }
