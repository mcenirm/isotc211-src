 ...
 */
public class MultiGeometryPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.MultiGeometryPropertyType
{
    ...
    public boolean isSetAbstractGeometricAggregate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTGEOMETRICAGGREGATE$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractGeometricAggregate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTGEOMETRICAGGREGATE$1, 0);
        }
    }
