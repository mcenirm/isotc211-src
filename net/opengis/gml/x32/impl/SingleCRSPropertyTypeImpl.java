 ...
 */
public class SingleCRSPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.SingleCRSPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public SingleCRSPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractSingleCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTSINGLECRS$1) != 0;
        }
    }
