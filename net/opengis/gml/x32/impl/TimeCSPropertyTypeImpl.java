 ...
 */
public class TimeCSPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.TimeCSPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeCSPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMECS$0) != 0;
        }
    }
    ...
    public void unsetTimeCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(TIMECS$0, 0);
        }
    }
