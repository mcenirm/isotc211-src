 ...
 */
public class GeodeticCRSPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.GeodeticCRSPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public GeodeticCRSPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeodeticCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEODETICCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetGeodeticCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(GEODETICCRS$0, 0);
        }
    }
