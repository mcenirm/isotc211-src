 ...
 */
public class CurvePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.x32.CurvePropertyType
{
    ...
    public boolean isSetAbstractCurve()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTCURVE$1) != 0;
        }
    }
    ...
    public void unsetAbstractCurve()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTCURVE$1, 0);
        }
    }
