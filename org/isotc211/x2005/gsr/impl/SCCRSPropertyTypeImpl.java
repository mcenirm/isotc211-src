 ...
 */
package org.isotc211.x2005.gsr.impl;
/**
 * An XML SC_CRS_PropertyType(@http://www.isotc211.org/2005/gsr).
 *
 * This is a complex type.
 */
public class SCCRSPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gsr.SCCRSPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public SCCRSPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTCRS$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTCRS$1, 0);
        }
    }
