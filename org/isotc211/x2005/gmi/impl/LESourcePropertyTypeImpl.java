 ...
 */
public class LESourcePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.LESourcePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LESourcePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLESource()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LESOURCE$0) != 0;
        }
    }
     ...
     */
    public void unsetLESource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LESOURCE$0, 0);
        }
    }
