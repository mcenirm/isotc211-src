 ...
 */
public class MIGCPPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIGCPPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIGCPPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIGCP()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIGCP$0) != 0;
        }
    }
     ...
     */
    public void unsetMIGCP()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIGCP$0, 0);
        }
    }
