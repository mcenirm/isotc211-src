 ...
 */
public class MISensorTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MISensorTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MISensorTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMISensorTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MISENSORTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMISensorTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MISENSORTYPECODE$0, 0);
        }
    }
