 ...
 */
public class MIRequirementPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIRequirementPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIRequirementPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIRequirement()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIREQUIREMENT$0) != 0;
        }
    }
     ...
     */
    public void unsetMIRequirement()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIREQUIREMENT$0, 0);
        }
    }
