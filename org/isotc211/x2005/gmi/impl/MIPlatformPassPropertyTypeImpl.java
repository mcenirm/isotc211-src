 ...
 */
public class MIPlatformPassPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIPlatformPassPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIPlatformPassPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIPlatformPass()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIPLATFORMPASS$0) != 0;
        }
    }
     ...
     */
    public void unsetMIPlatformPass()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIPLATFORMPASS$0, 0);
        }
    }
