 ...
 */
public class MIGeorectifiedPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIGeorectifiedPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIGeorectifiedPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIGeorectified()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIGEORECTIFIED$0) != 0;
        }
    }
     ...
     */
    public void unsetMIGeorectified()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIGEORECTIFIED$0, 0);
        }
    }
