 ...
 */
public class MIInstrumentPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIInstrumentPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIInstrumentPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIInstrument()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIINSTRUMENT$0) != 0;
        }
    }
     ...
     */
    public void unsetMIInstrument()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIINSTRUMENT$0, 0);
        }
    }
