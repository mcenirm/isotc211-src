 ...
 */
public class MITransferFunctionTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MITransferFunctionTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MITransferFunctionTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMITransferFunctionTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MITRANSFERFUNCTIONTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMITransferFunctionTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MITRANSFERFUNCTIONTYPECODE$0, 0);
        }
    }
