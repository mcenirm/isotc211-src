 ...
 */
public class MIPlatformPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIPlatformPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIPlatformPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIPlatform()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIPLATFORM$0) != 0;
        }
    }
     ...
     */
    public void unsetMIPlatform()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIPLATFORM$0, 0);
        }
    }
