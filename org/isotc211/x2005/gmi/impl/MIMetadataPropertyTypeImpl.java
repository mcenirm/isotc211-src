 ...
 */
public class MIMetadataPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIMetadataPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIMetadataPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIMetadata()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIMETADATA$0) != 0;
        }
    }
     ...
     */
    public void unsetMIMetadata()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIMETADATA$0, 0);
        }
    }
