 ...
 */
public class MIGeolocationInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIGeolocationInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIGeolocationInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractMIGeolocationInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTMIGEOLOCATIONINFORMATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractMIGeolocationInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTMIGEOLOCATIONINFORMATION$1, 0);
        }
    }
