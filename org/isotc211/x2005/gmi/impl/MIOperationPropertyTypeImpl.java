 ...
 */
public class MIOperationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIOperationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIOperationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIOPERATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMIOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIOPERATION$0, 0);
        }
    }
