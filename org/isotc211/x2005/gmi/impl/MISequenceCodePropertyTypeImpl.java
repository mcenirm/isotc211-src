 ...
 */
public class MISequenceCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MISequenceCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MISequenceCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMISequenceCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MISEQUENCECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMISequenceCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MISEQUENCECODE$0, 0);
        }
    }
