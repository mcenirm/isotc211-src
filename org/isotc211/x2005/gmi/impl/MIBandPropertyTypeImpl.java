 ...
 */
public class MIBandPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIBandPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIBandPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIBand()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIBAND$0) != 0;
        }
    }
     ...
     */
    public void unsetMIBand()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIBAND$0, 0);
        }
    }
