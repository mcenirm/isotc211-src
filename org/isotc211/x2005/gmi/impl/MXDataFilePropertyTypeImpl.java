 ...
 */
public class MXDataFilePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MXDataFilePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MXDataFilePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMXDataFile()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MXDATAFILE$0) != 0;
        }
    }
     ...
     */
    public void unsetMXDataFile()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MXDATAFILE$0, 0);
        }
    }
