 ...
 */
public class QEUsabilityPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.QEUsabilityPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public QEUsabilityPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetQEUsability()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(QEUSABILITY$0) != 0;
        }
    }
     ...
     */
    public void unsetQEUsability()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(QEUSABILITY$0, 0);
        }
    }
