 ...
 */
public class LEAlgorithmPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.LEAlgorithmPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LEAlgorithmPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLEAlgorithm()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LEALGORITHM$0) != 0;
        }
    }
     ...
     */
    public void unsetLEAlgorithm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LEALGORITHM$0, 0);
        }
    }
