 ...
 */
public class LEProcessStepPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.LEProcessStepPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LEProcessStepPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLEProcessStep()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LEPROCESSSTEP$0) != 0;
        }
    }
     ...
     */
    public void unsetLEProcessStep()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LEPROCESSSTEP$0, 0);
        }
    }
