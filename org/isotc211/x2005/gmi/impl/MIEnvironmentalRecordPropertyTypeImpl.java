 ...
 */
public class MIEnvironmentalRecordPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIEnvironmentalRecordPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIEnvironmentalRecordPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIEnvironmentalRecord()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIENVIRONMENTALRECORD$0) != 0;
        }
    }
     ...
     */
    public void unsetMIEnvironmentalRecord()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIENVIRONMENTALRECORD$0, 0);
        }
    }
