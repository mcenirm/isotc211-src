 ...
 */
public class LEProcessingPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.LEProcessingPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LEProcessingPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLEProcessing()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LEPROCESSING$0) != 0;
        }
    }
     ...
     */
    public void unsetLEProcessing()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LEPROCESSING$0, 0);
        }
    }
