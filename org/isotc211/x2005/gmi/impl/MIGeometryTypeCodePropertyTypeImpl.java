 ...
 */
public class MIGeometryTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIGeometryTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIGeometryTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIGeometryTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIGEOMETRYTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMIGeometryTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIGEOMETRYTYPECODE$0, 0);
        }
    }
