 ...
 */
public class MIEventPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIEventPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIEventPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIEvent()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIEVENT$0) != 0;
        }
    }
     ...
     */
    public void unsetMIEvent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIEVENT$0, 0);
        }
    }
