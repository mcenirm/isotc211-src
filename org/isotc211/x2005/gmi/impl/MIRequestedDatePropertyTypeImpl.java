 ...
 */
public class MIRequestedDatePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIRequestedDatePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIRequestedDatePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIRequestedDate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIREQUESTEDDATE$0) != 0;
        }
    }
     ...
     */
    public void unsetMIRequestedDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIREQUESTEDDATE$0, 0);
        }
    }
