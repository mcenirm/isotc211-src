 ...
 */
public class MIGCPCollectionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIGCPCollectionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIGCPCollectionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIGCPCollection()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIGCPCOLLECTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMIGCPCollection()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIGCPCOLLECTION$0, 0);
        }
    }
