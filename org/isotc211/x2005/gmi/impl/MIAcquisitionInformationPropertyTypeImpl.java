 ...
 */
public class MIAcquisitionInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIAcquisitionInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIAcquisitionInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIAcquisitionInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIACQUISITIONINFORMATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMIAcquisitionInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIACQUISITIONINFORMATION$0, 0);
        }
    }
