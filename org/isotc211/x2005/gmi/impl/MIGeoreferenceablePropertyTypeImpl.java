 ...
 */
public class MIGeoreferenceablePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIGeoreferenceablePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIGeoreferenceablePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIGeoreferenceable()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIGEOREFERENCEABLE$0) != 0;
        }
    }
     ...
     */
    public void unsetMIGeoreferenceable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIGEOREFERENCEABLE$0, 0);
        }
    }
