 ...
 */
public class MIBandDefinitionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIBandDefinitionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIBandDefinitionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIBandDefinition()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIBANDDEFINITION$0) != 0;
        }
    }
     ...
     */
    public void unsetMIBandDefinition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIBANDDEFINITION$0, 0);
        }
    }
