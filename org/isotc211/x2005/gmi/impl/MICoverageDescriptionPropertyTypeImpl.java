 ...
 */
public class MICoverageDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MICoverageDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MICoverageDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMICoverageDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MICOVERAGEDESCRIPTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMICoverageDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MICOVERAGEDESCRIPTION$0, 0);
        }
    }
