 ...
 */
public class QECoverageResultPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.QECoverageResultPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public QECoverageResultPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetQECoverageResult()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(QECOVERAGERESULT$0) != 0;
        }
    }
     ...
     */
    public void unsetQECoverageResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(QECOVERAGERESULT$0, 0);
        }
    }
