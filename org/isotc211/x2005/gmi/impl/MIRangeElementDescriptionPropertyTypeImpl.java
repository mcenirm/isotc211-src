 ...
 */
public class MIRangeElementDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIRangeElementDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIRangeElementDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIRangeElementDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIRANGEELEMENTDESCRIPTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMIRangeElementDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIRANGEELEMENTDESCRIPTION$0, 0);
        }
    }
