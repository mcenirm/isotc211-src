 ...
 */
public class MIPlanPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIPlanPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIPlanPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIPlan()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIPLAN$0) != 0;
        }
    }
     ...
     */
    public void unsetMIPlan()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIPLAN$0, 0);
        }
    }
