 ...
 */
public class MIOperationTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIOperationTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIOperationTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIOperationTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIOPERATIONTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMIOperationTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIOPERATIONTYPECODE$0, 0);
        }
    }
