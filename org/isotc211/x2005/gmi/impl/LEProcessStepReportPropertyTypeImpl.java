 ...
 */
public class LEProcessStepReportPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.LEProcessStepReportPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LEProcessStepReportPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLEProcessStepReport()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LEPROCESSSTEPREPORT$0) != 0;
        }
    }
     ...
     */
    public void unsetLEProcessStepReport()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LEPROCESSSTEPREPORT$0, 0);
        }
    }
