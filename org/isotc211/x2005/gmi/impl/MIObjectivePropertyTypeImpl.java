 ...
 */
public class MIObjectivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIObjectivePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIObjectivePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIObjective()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIOBJECTIVE$0) != 0;
        }
    }
     ...
     */
    public void unsetMIObjective()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIOBJECTIVE$0, 0);
        }
    }
