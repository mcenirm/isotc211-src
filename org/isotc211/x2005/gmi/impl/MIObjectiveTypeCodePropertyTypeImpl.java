 ...
 */
public class MIObjectiveTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIObjectiveTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIObjectiveTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIObjectiveTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIOBJECTIVETYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMIObjectiveTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIOBJECTIVETYPECODE$0, 0);
        }
    }
