 ...
 */
public class MIImageDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmi.MIImageDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MIImageDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMIImageDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MIIMAGEDESCRIPTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMIImageDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MIIMAGEDESCRIPTION$0, 0);
        }
    }
