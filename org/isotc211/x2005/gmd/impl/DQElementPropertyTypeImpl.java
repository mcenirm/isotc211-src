 ...
 */
public class DQElementPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQElementPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQElementPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDQElement()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDQELEMENT$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDQElement()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDQELEMENT$1, 0);
        }
    }
