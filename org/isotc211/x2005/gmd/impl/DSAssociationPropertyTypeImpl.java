 ...
 */
public class DSAssociationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSAssociationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSAssociationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSAssociation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSASSOCIATION$0) != 0;
        }
    }
     ...
     */
    public void unsetDSAssociation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSASSOCIATION$0, 0);
        }
    }
