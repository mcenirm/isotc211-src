 ...
 */
public class DQQuantitativeAttributeAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQQuantitativeAttributeAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQQuantitativeAttributeAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQQuantitativeAttributeAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQQUANTITATIVEATTRIBUTEACCURACY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQQuantitativeAttributeAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQQUANTITATIVEATTRIBUTEACCURACY$0, 0);
        }
    }
