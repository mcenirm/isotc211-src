 ...
 */
public class MDDistributorPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDistributorPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDistributorPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDistributor()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDISTRIBUTOR$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDistributor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDISTRIBUTOR$0, 0);
        }
    }
