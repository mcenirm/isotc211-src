 ...
 */
public class PTLocalePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.PTLocalePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public PTLocalePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetPTLocale()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PTLOCALE$0) != 0;
        }
    }
     ...
     */
    public void unsetPTLocale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(PTLOCALE$0, 0);
        }
    }
