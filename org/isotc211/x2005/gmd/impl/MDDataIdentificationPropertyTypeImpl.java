 ...
 */
public class MDDataIdentificationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDataIdentificationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDataIdentificationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDataIdentification()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDATAIDENTIFICATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDataIdentification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDATAIDENTIFICATION$0, 0);
        }
    }
