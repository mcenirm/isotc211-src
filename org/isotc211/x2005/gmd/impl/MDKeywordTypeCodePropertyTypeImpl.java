 ...
 */
public class MDKeywordTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDKeywordTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDKeywordTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDKeywordTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDKEYWORDTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDKeywordTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDKEYWORDTYPECODE$0, 0);
        }
    }
