 ...
 */
public class LISourcePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.LISourcePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LISourcePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLISource()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LISOURCE$1) != 0;
        }
    }
     ...
     */
    public void unsetLISource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LISOURCE$1, 0);
        }
    }
