 ...
 */
public class MDIdentificationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDIdentificationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDIdentificationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractMDIdentification()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTMDIDENTIFICATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractMDIdentification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTMDIDENTIFICATION$1, 0);
        }
    }
