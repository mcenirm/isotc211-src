 ...
 */
public class DQScopePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQScopePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQScopePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQScope()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQSCOPE$0) != 0;
        }
    }
     ...
     */
    public void unsetDQScope()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQSCOPE$0, 0);
        }
    }
