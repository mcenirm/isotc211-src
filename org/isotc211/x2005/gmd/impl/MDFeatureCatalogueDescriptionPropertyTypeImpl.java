 ...
 */
public class MDFeatureCatalogueDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDFeatureCatalogueDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDFeatureCatalogueDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDFeatureCatalogueDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDFEATURECATALOGUEDESCRIPTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDFeatureCatalogueDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDFEATURECATALOGUEDESCRIPTION$0, 0);
        }
    }
