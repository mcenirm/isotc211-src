 ...
 */
public class DQDomainConsistencyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQDomainConsistencyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQDomainConsistencyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQDomainConsistency()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQDOMAINCONSISTENCY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQDomainConsistency()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQDOMAINCONSISTENCY$0, 0);
        }
    }
