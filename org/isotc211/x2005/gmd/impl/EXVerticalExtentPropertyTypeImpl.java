 ...
 */
public class EXVerticalExtentPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.EXVerticalExtentPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public EXVerticalExtentPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEXVerticalExtent()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(EXVERTICALEXTENT$0) != 0;
        }
    }
     ...
     */
    public void unsetEXVerticalExtent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(EXVERTICALEXTENT$0, 0);
        }
    }
