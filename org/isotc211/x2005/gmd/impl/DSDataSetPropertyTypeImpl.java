 ...
 */
public class DSDataSetPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSDataSetPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSDataSetPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSDataSet()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSDATASET$0) != 0;
        }
    }
     ...
     */
    public void unsetDSDataSet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSDATASET$0, 0);
        }
    }
