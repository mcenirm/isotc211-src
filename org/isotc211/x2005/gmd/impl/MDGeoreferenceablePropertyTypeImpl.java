 ...
 */
public class MDGeoreferenceablePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDGeoreferenceablePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDGeoreferenceablePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDGeoreferenceable()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDGEOREFERENCEABLE$1) != 0;
        }
    }
     ...
     */
    public void unsetMDGeoreferenceable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDGEOREFERENCEABLE$1, 0);
        }
    }
