 ...
 */
public class DQQuantitativeResultPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQQuantitativeResultPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQQuantitativeResultPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQQuantitativeResult()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQQUANTITATIVERESULT$0) != 0;
        }
    }
     ...
     */
    public void unsetDQQuantitativeResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQQUANTITATIVERESULT$0, 0);
        }
    }
