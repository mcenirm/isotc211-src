 ...
 */
public class MDUsagePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDUsagePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDUsagePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDUsage()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDUSAGE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDUsage()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDUSAGE$0, 0);
        }
    }
