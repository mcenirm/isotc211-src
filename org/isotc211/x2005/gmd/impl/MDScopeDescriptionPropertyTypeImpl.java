 ...
 */
public class MDScopeDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDScopeDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDScopeDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDScopeDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDSCOPEDESCRIPTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDScopeDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDSCOPEDESCRIPTION$0, 0);
        }
    }
