 ...
 */
public class MDBandPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDBandPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDBandPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDBand()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDBAND$1) != 0;
        }
    }
     ...
     */
    public void unsetMDBand()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDBAND$1, 0);
        }
    }
