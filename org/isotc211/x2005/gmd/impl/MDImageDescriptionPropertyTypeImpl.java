 ...
 */
public class MDImageDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDImageDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDImageDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDImageDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDIMAGEDESCRIPTION$1) != 0;
        }
    }
     ...
     */
    public void unsetMDImageDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDIMAGEDESCRIPTION$1, 0);
        }
    }
