 ...
 */
public class DQGriddedDataPositionalAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQGriddedDataPositionalAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQGriddedDataPositionalAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQGriddedDataPositionalAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQGRIDDEDDATAPOSITIONALACCURACY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQGriddedDataPositionalAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQGRIDDEDDATAPOSITIONALACCURACY$0, 0);
        }
    }
