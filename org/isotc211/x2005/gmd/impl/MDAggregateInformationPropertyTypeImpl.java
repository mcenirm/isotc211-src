 ...
 */
public class MDAggregateInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDAggregateInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDAggregateInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDAggregateInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDAGGREGATEINFORMATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDAggregateInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDAGGREGATEINFORMATION$0, 0);
        }
    }
