 ...
 */
public class MDCharacterSetCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDCharacterSetCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDCharacterSetCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDCharacterSetCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDCHARACTERSETCODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDCharacterSetCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDCHARACTERSETCODE$0, 0);
        }
    }
