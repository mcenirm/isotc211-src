 ...
 */
public class CIResponsiblePartyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CIResponsiblePartyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CIResponsiblePartyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCIResponsibleParty()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CIRESPONSIBLEPARTY$0) != 0;
        }
    }
     ...
     */
    public void unsetCIResponsibleParty()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CIRESPONSIBLEPARTY$0, 0);
        }
    }
