 ...
 */
public class MDServiceIdentificationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDServiceIdentificationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDServiceIdentificationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDServiceIdentification()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDSERVICEIDENTIFICATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDServiceIdentification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDSERVICEIDENTIFICATION$0, 0);
        }
    }
