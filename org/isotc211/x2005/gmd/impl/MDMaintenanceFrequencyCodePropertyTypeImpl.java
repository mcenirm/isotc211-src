 ...
 */
public class MDMaintenanceFrequencyCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDMaintenanceFrequencyCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDMaintenanceFrequencyCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDMaintenanceFrequencyCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDMAINTENANCEFREQUENCYCODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDMaintenanceFrequencyCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDMAINTENANCEFREQUENCYCODE$0, 0);
        }
    }
