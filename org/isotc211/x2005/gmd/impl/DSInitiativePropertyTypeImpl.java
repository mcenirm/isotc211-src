 ...
 */
public class DSInitiativePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSInitiativePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSInitiativePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSInitiative()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSINITIATIVE$0) != 0;
        }
    }
     ...
     */
    public void unsetDSInitiative()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSINITIATIVE$0, 0);
        }
    }
