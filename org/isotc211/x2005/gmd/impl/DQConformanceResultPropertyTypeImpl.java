 ...
 */
public class DQConformanceResultPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQConformanceResultPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQConformanceResultPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQConformanceResult()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQCONFORMANCERESULT$0) != 0;
        }
    }
     ...
     */
    public void unsetDQConformanceResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQCONFORMANCERESULT$0, 0);
        }
    }
