 ...
 */
public class MDDatatypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDatatypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDatatypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDatatypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDATATYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDatatypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDATATYPECODE$0, 0);
        }
    }
