 ...
 */
public class DQLogicalConsistencyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQLogicalConsistencyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQLogicalConsistencyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDQLogicalConsistency()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDQLOGICALCONSISTENCY$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDQLogicalConsistency()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDQLOGICALCONSISTENCY$1, 0);
        }
    }
