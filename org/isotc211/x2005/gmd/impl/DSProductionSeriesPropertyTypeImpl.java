 ...
 */
public class DSProductionSeriesPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSProductionSeriesPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSProductionSeriesPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSProductionSeries()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSPRODUCTIONSERIES$0) != 0;
        }
    }
     ...
     */
    public void unsetDSProductionSeries()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSPRODUCTIONSERIES$0, 0);
        }
    }
