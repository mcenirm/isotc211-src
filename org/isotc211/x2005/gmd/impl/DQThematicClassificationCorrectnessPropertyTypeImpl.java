 ...
 */
public class DQThematicClassificationCorrectnessPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQThematicClassificationCorrectnessPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQThematicClassificationCorrectnessPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQThematicClassificationCorrectness()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQTHEMATICCLASSIFICATIONCORRECTNESS$0) != 0;
        }
    }
     ...
     */
    public void unsetDQThematicClassificationCorrectness()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQTHEMATICCLASSIFICATIONCORRECTNESS$0, 0);
        }
    }
