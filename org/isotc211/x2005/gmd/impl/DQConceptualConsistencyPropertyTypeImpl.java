 ...
 */
public class DQConceptualConsistencyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQConceptualConsistencyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQConceptualConsistencyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQConceptualConsistency()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQCONCEPTUALCONSISTENCY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQConceptualConsistency()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQCONCEPTUALCONSISTENCY$0, 0);
        }
    }
