 ...
 */
public class MDVectorSpatialRepresentationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDVectorSpatialRepresentationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDVectorSpatialRepresentationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDVectorSpatialRepresentation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDVECTORSPATIALREPRESENTATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDVectorSpatialRepresentation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDVECTORSPATIALREPRESENTATION$0, 0);
        }
    }
