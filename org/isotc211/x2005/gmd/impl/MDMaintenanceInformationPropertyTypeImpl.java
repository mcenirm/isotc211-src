 ...
 */
public class MDMaintenanceInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDMaintenanceInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDMaintenanceInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDMaintenanceInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDMAINTENANCEINFORMATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDMaintenanceInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDMAINTENANCEINFORMATION$0, 0);
        }
    }
