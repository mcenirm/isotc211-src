 ...
 */
public class DSAggregatePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSAggregatePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSAggregatePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDSAggregate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDSAGGREGATE$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDSAggregate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDSAGGREGATE$1, 0);
        }
    }
