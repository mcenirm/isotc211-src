 ...
 */
public class MDSpatialRepresentationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDSpatialRepresentationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDSpatialRepresentationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractMDSpatialRepresentation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTMDSPATIALREPRESENTATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractMDSpatialRepresentation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTMDSPATIALREPRESENTATION$1, 0);
        }
    }
