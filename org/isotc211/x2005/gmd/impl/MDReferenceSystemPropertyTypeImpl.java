 ...
 */
public class MDReferenceSystemPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDReferenceSystemPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDReferenceSystemPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDReferenceSystem()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDREFERENCESYSTEM$0) != 0;
        }
    }
     ...
     */
    public void unsetMDReferenceSystem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDREFERENCESYSTEM$0, 0);
        }
    }
