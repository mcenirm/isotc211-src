 ...
 */
public class CITelephonePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CITelephonePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CITelephonePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCITelephone()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CITELEPHONE$0) != 0;
        }
    }
     ...
     */
    public void unsetCITelephone()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CITELEPHONE$0, 0);
        }
    }
