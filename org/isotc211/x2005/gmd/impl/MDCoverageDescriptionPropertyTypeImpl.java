 ...
 */
public class MDCoverageDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDCoverageDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDCoverageDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDCoverageDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDCOVERAGEDESCRIPTION$1) != 0;
        }
    }
     ...
     */
    public void unsetMDCoverageDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDCOVERAGEDESCRIPTION$1, 0);
        }
    }
