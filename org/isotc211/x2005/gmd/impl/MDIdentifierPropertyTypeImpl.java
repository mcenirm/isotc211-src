 ...
 */
public class MDIdentifierPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDIdentifierPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDIdentifierPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDIdentifier()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDIDENTIFIER$1) != 0;
        }
    }
     ...
     */
    public void unsetMDIdentifier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDIDENTIFIER$1, 0);
        }
    }
