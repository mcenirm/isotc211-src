 ...
 */
public class MDGeorectifiedPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDGeorectifiedPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDGeorectifiedPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDGeorectified()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDGEORECTIFIED$1) != 0;
        }
    }
     ...
     */
    public void unsetMDGeorectified()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDGEORECTIFIED$1, 0);
        }
    }
