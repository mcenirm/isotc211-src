 ...
 */
public class MDClassificationCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDClassificationCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDClassificationCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDClassificationCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDCLASSIFICATIONCODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDClassificationCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDCLASSIFICATIONCODE$0, 0);
        }
    }
