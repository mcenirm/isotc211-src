 ...
 */
public class MDDimensionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDimensionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDimensionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDimension()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDIMENSION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDimension()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDIMENSION$0, 0);
        }
    }
