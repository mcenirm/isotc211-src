 ...
 */
public class MDResolutionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDResolutionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDResolutionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDResolution()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDRESOLUTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDResolution()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDRESOLUTION$0, 0);
        }
    }
