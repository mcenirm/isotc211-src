 ...
 */
public class DQResultPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQResultPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQResultPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDQResult()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDQRESULT$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDQResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDQRESULT$1, 0);
        }
    }
