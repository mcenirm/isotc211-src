 ...
 */
public class DQTemporalConsistencyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQTemporalConsistencyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQTemporalConsistencyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQTemporalConsistency()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQTEMPORALCONSISTENCY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQTemporalConsistency()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQTEMPORALCONSISTENCY$0, 0);
        }
    }
