 ...
 */
public class DSSeriesPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSSeriesPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSSeriesPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSSeries()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSSERIES$1) != 0;
        }
    }
     ...
     */
    public void unsetDSSeries()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSSERIES$1, 0);
        }
    }
