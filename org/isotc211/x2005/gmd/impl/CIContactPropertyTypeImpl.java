 ...
 */
public class CIContactPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CIContactPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CIContactPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCIContact()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CICONTACT$0) != 0;
        }
    }
     ...
     */
    public void unsetCIContact()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CICONTACT$0, 0);
        }
    }
