 ...
 */
public class MDApplicationSchemaInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDApplicationSchemaInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDApplicationSchemaInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDApplicationSchemaInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDAPPLICATIONSCHEMAINFORMATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDApplicationSchemaInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDAPPLICATIONSCHEMAINFORMATION$0, 0);
        }
    }
