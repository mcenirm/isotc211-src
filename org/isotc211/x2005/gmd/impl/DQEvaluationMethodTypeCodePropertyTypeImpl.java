 ...
 */
public class DQEvaluationMethodTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQEvaluationMethodTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQEvaluationMethodTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQEvaluationMethodTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQEVALUATIONMETHODTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetDQEvaluationMethodTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQEVALUATIONMETHODTYPECODE$0, 0);
        }
    }
