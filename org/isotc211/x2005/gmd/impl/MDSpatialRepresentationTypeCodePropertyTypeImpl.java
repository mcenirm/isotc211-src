 ...
 */
public class MDSpatialRepresentationTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDSpatialRepresentationTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDSpatialRepresentationTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDSpatialRepresentationTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDSPATIALREPRESENTATIONTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDSpatialRepresentationTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDSPATIALREPRESENTATIONTYPECODE$0, 0);
        }
    }
