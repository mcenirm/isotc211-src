 ...
 */
public class MDMediumPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDMediumPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDMediumPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDMedium()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDMEDIUM$0) != 0;
        }
    }
     ...
     */
    public void unsetMDMedium()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDMEDIUM$0, 0);
        }
    }
