 ...
 */
public class MDPortrayalCatalogueReferencePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDPortrayalCatalogueReferencePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDPortrayalCatalogueReferencePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDPortrayalCatalogueReference()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDPORTRAYALCATALOGUEREFERENCE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDPortrayalCatalogueReference()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDPORTRAYALCATALOGUEREFERENCE$0, 0);
        }
    }
