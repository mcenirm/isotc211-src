 ...
 */
public class MDRepresentativeFractionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDRepresentativeFractionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDRepresentativeFractionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDRepresentativeFraction()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDREPRESENTATIVEFRACTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDRepresentativeFraction()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDREPRESENTATIVEFRACTION$0, 0);
        }
    }
