 ...
 */
public class DQNonQuantitativeAttributeAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQNonQuantitativeAttributeAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQNonQuantitativeAttributeAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQNonQuantitativeAttributeAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQNONQUANTITATIVEATTRIBUTEACCURACY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQNonQuantitativeAttributeAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQNONQUANTITATIVEATTRIBUTEACCURACY$0, 0);
        }
    }
