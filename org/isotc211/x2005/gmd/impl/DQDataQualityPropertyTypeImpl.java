 ...
 */
public class DQDataQualityPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQDataQualityPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQDataQualityPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQDataQuality()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQDATAQUALITY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQDataQuality()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQDATAQUALITY$0, 0);
        }
    }
