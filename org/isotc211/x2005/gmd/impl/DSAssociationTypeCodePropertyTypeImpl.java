 ...
 */
public class DSAssociationTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSAssociationTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSAssociationTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSAssociationTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSASSOCIATIONTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetDSAssociationTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSASSOCIATIONTYPECODE$0, 0);
        }
    }
