 ...
 */
public class MDRestrictionCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDRestrictionCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDRestrictionCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDRestrictionCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDRESTRICTIONCODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDRestrictionCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDRESTRICTIONCODE$0, 0);
        }
    }
