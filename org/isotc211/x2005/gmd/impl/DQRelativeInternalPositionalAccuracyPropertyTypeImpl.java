 ...
 */
public class DQRelativeInternalPositionalAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQRelativeInternalPositionalAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQRelativeInternalPositionalAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQRelativeInternalPositionalAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQRELATIVEINTERNALPOSITIONALACCURACY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQRelativeInternalPositionalAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQRELATIVEINTERNALPOSITIONALACCURACY$0, 0);
        }
    }
