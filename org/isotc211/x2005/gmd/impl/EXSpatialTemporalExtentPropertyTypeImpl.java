 ...
 */
public class EXSpatialTemporalExtentPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.EXSpatialTemporalExtentPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public EXSpatialTemporalExtentPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEXSpatialTemporalExtent()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(EXSPATIALTEMPORALEXTENT$0) != 0;
        }
    }
     ...
     */
    public void unsetEXSpatialTemporalExtent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(EXSPATIALTEMPORALEXTENT$0, 0);
        }
    }
