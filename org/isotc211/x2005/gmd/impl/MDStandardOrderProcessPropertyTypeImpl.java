 ...
 */
public class MDStandardOrderProcessPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDStandardOrderProcessPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDStandardOrderProcessPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDStandardOrderProcess()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDSTANDARDORDERPROCESS$0) != 0;
        }
    }
     ...
     */
    public void unsetMDStandardOrderProcess()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDSTANDARDORDERPROCESS$0, 0);
        }
    }
