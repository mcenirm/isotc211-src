 ...
 */
public class DQThematicAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQThematicAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQThematicAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDQThematicAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDQTHEMATICACCURACY$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDQThematicAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDQTHEMATICACCURACY$1, 0);
        }
    }
