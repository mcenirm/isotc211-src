 ...
 */
public class MDBrowseGraphicPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDBrowseGraphicPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDBrowseGraphicPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDBrowseGraphic()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDBROWSEGRAPHIC$0) != 0;
        }
    }
     ...
     */
    public void unsetMDBrowseGraphic()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDBROWSEGRAPHIC$0, 0);
        }
    }
