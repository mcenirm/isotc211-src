 ...
 */
public class CIPresentationFormCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CIPresentationFormCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CIPresentationFormCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCIPresentationFormCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CIPRESENTATIONFORMCODE$0) != 0;
        }
    }
     ...
     */
    public void unsetCIPresentationFormCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CIPRESENTATIONFORMCODE$0, 0);
        }
    }
