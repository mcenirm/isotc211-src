 ...
 */
public class MDExtendedElementInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDExtendedElementInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDExtendedElementInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDExtendedElementInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDEXTENDEDELEMENTINFORMATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDExtendedElementInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDEXTENDEDELEMENTINFORMATION$0, 0);
        }
    }
