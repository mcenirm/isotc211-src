 ...
 */
public class DSPlatformPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSPlatformPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSPlatformPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSPlatform()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSPLATFORM$0) != 0;
        }
    }
     ...
     */
    public void unsetDSPlatform()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSPLATFORM$0, 0);
        }
    }
