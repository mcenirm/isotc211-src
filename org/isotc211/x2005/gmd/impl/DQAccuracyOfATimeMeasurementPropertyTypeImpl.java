 ...
 */
public class DQAccuracyOfATimeMeasurementPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQAccuracyOfATimeMeasurementPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQAccuracyOfATimeMeasurementPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQAccuracyOfATimeMeasurement()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQACCURACYOFATIMEMEASUREMENT$0) != 0;
        }
    }
     ...
     */
    public void unsetDQAccuracyOfATimeMeasurement()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQACCURACYOFATIMEMEASUREMENT$0, 0);
        }
    }
