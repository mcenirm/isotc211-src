 ...
 */
public class MDDistributionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDistributionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDistributionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDistribution()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDISTRIBUTION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDistribution()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDISTRIBUTION$0, 0);
        }
    }
