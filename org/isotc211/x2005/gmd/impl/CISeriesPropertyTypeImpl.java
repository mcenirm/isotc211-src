 ...
 */
public class CISeriesPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CISeriesPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CISeriesPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCISeries()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CISERIES$0) != 0;
        }
    }
     ...
     */
    public void unsetCISeries()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CISERIES$0, 0);
        }
    }
