 ...
 */
public class LIProcessStepPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.LIProcessStepPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LIProcessStepPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLIProcessStep()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LIPROCESSSTEP$1) != 0;
        }
    }
     ...
     */
    public void unsetLIProcessStep()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LIPROCESSSTEP$1, 0);
        }
    }
