 ...
 */
public class DQTemporalValidityPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQTemporalValidityPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQTemporalValidityPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQTemporalValidity()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQTEMPORALVALIDITY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQTemporalValidity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQTEMPORALVALIDITY$0, 0);
        }
    }
