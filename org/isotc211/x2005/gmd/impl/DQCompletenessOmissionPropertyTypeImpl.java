 ...
 */
public class DQCompletenessOmissionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQCompletenessOmissionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQCompletenessOmissionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQCompletenessOmission()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQCOMPLETENESSOMISSION$0) != 0;
        }
    }
     ...
     */
    public void unsetDQCompletenessOmission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQCOMPLETENESSOMISSION$0, 0);
        }
    }
