 ...
 */
public class MDCoverageContentTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDCoverageContentTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDCoverageContentTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDCoverageContentTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDCOVERAGECONTENTTYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDCoverageContentTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDCOVERAGECONTENTTYPECODE$0, 0);
        }
    }
