 ...
 */
public class DSOtherAggregatePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSOtherAggregatePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSOtherAggregatePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSOtherAggregate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSOTHERAGGREGATE$1) != 0;
        }
    }
     ...
     */
    public void unsetDSOtherAggregate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSOTHERAGGREGATE$1, 0);
        }
    }
