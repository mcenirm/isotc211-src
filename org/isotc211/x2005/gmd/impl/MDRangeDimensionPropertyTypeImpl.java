 ...
 */
public class MDRangeDimensionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDRangeDimensionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDRangeDimensionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDRangeDimension()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDRANGEDIMENSION$1) != 0;
        }
    }
     ...
     */
    public void unsetMDRangeDimension()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDRANGEDIMENSION$1, 0);
        }
    }
