 ...
 */
public class RSReferenceSystemPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.RSReferenceSystemPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public RSReferenceSystemPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractRSReferenceSystem()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTRSREFERENCESYSTEM$0) != 0;
        }
    }
     ...
     */
    public void unsetAbstractRSReferenceSystem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTRSREFERENCESYSTEM$0, 0);
        }
    }
