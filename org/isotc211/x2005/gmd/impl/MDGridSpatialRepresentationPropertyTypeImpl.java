 ...
 */
public class MDGridSpatialRepresentationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDGridSpatialRepresentationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDGridSpatialRepresentationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDGridSpatialRepresentation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDGRIDSPATIALREPRESENTATION$1) != 0;
        }
    }
     ...
     */
    public void unsetMDGridSpatialRepresentation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDGRIDSPATIALREPRESENTATION$1, 0);
        }
    }
