 ...
 */
public class DQTemporalAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQTemporalAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQTemporalAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDQTemporalAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDQTEMPORALACCURACY$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDQTemporalAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDQTEMPORALACCURACY$1, 0);
        }
    }
