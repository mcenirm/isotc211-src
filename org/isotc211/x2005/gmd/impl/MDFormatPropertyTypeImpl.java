 ...
 */
public class MDFormatPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDFormatPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDFormatPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDFormat()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDFORMAT$0) != 0;
        }
    }
     ...
     */
    public void unsetMDFormat()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDFORMAT$0, 0);
        }
    }
