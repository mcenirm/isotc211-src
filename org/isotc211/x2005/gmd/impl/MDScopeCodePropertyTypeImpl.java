 ...
 */
public class MDScopeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDScopeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDScopeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDScopeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDSCOPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetMDScopeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDSCOPECODE$0, 0);
        }
    }
