 ...
 */
public class EXGeographicDescriptionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.EXGeographicDescriptionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public EXGeographicDescriptionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEXGeographicDescription()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(EXGEOGRAPHICDESCRIPTION$0) != 0;
        }
    }
     ...
     */
    public void unsetEXGeographicDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(EXGEOGRAPHICDESCRIPTION$0, 0);
        }
    }
