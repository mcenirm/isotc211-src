 ...
 */
public class DQCompletenessPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQCompletenessPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQCompletenessPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractDQCompleteness()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTDQCOMPLETENESS$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractDQCompleteness()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTDQCOMPLETENESS$1, 0);
        }
    }
