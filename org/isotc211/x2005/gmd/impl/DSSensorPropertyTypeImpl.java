 ...
 */
public class DSSensorPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSSensorPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSSensorPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSSensor()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSSENSOR$0) != 0;
        }
    }
     ...
     */
    public void unsetDSSensor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSSENSOR$0, 0);
        }
    }
