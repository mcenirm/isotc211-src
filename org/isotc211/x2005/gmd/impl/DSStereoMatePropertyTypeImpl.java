 ...
 */
public class DSStereoMatePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSStereoMatePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSStereoMatePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSStereoMate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSSTEREOMATE$0) != 0;
        }
    }
     ...
     */
    public void unsetDSStereoMate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSSTEREOMATE$0, 0);
        }
    }
