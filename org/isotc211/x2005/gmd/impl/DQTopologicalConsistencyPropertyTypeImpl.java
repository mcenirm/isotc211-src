 ...
 */
public class DQTopologicalConsistencyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQTopologicalConsistencyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQTopologicalConsistencyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQTopologicalConsistency()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQTOPOLOGICALCONSISTENCY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQTopologicalConsistency()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQTOPOLOGICALCONSISTENCY$0, 0);
        }
    }
