 ...
 */
public class MDMetadataPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDMetadataPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDMetadataPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDMetadata()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDMETADATA$1) != 0;
        }
    }
     ...
     */
    public void unsetMDMetadata()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDMETADATA$1, 0);
        }
    }
