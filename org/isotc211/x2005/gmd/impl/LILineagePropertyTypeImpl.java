 ...
 */
public class LILineagePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.LILineagePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LILineagePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLILineage()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LILINEAGE$0) != 0;
        }
    }
     ...
     */
    public void unsetLILineage()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LILINEAGE$0, 0);
        }
    }
