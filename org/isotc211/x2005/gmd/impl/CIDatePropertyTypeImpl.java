 ...
 */
public class CIDatePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CIDatePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CIDatePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCIDate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CIDATE$0) != 0;
        }
    }
     ...
     */
    public void unsetCIDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CIDATE$0, 0);
        }
    }
