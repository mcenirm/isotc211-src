 ...
 */
public class MDDistributionUnitsPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDistributionUnitsPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDistributionUnitsPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDistributionUnits()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDISTRIBUTIONUNITS$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDistributionUnits()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDISTRIBUTIONUNITS$0, 0);
        }
    }
