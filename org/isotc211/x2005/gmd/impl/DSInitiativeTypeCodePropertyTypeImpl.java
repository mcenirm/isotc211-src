 ...
 */
public class DSInitiativeTypeCodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DSInitiativeTypeCodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DSInitiativeTypeCodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDSInitiativeTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DSINITIATIVETYPECODE$0) != 0;
        }
    }
     ...
     */
    public void unsetDSInitiativeTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DSINITIATIVETYPECODE$0, 0);
        }
    }
