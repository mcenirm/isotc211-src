 ...
 */
public class PTLocaleContainerPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.PTLocaleContainerPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public PTLocaleContainerPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetPTLocaleContainer()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PTLOCALECONTAINER$0) != 0;
        }
    }
     ...
     */
    public void unsetPTLocaleContainer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(PTLOCALECONTAINER$0, 0);
        }
    }
