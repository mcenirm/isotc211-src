 ...
 */
public class DQCompletenessCommissionPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQCompletenessCommissionPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQCompletenessCommissionPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQCompletenessCommission()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQCOMPLETENESSCOMMISSION$0) != 0;
        }
    }
     ...
     */
    public void unsetDQCompletenessCommission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQCOMPLETENESSCOMMISSION$0, 0);
        }
    }
