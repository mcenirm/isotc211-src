 ...
 */
public class EXTemporalExtentPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.EXTemporalExtentPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public EXTemporalExtentPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEXTemporalExtent()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(EXTEMPORALEXTENT$1) != 0;
        }
    }
     ...
     */
    public void unsetEXTemporalExtent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(EXTEMPORALEXTENT$1, 0);
        }
    }
