 ...
 */
public class DQAbsoluteExternalPositionalAccuracyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQAbsoluteExternalPositionalAccuracyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQAbsoluteExternalPositionalAccuracyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQAbsoluteExternalPositionalAccuracy()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQABSOLUTEEXTERNALPOSITIONALACCURACY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQAbsoluteExternalPositionalAccuracy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQABSOLUTEEXTERNALPOSITIONALACCURACY$0, 0);
        }
    }
