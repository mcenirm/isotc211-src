 ...
 */
public class CIAddressPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CIAddressPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CIAddressPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCIAddress()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CIADDRESS$0) != 0;
        }
    }
     ...
     */
    public void unsetCIAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CIADDRESS$0, 0);
        }
    }
