 ...
 */
public class RSIdentifierPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.RSIdentifierPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public RSIdentifierPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetRSIdentifier()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(RSIDENTIFIER$0) != 0;
        }
    }
     ...
     */
    public void unsetRSIdentifier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(RSIDENTIFIER$0, 0);
        }
    }
