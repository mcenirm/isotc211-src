 ...
 */
public class MDMetadataExtensionInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDMetadataExtensionInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDMetadataExtensionInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDMetadataExtensionInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDMETADATAEXTENSIONINFORMATION$0) != 0;
        }
    }
     ...
     */
    public void unsetMDMetadataExtensionInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDMETADATAEXTENSIONINFORMATION$0, 0);
        }
    }
