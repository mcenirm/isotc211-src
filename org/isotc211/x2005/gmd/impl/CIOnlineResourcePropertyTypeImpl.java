 ...
 */
public class CIOnlineResourcePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.CIOnlineResourcePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CIOnlineResourcePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCIOnlineResource()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CIONLINERESOURCE$0) != 0;
        }
    }
     ...
     */
    public void unsetCIOnlineResource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CIONLINERESOURCE$0, 0);
        }
    }
