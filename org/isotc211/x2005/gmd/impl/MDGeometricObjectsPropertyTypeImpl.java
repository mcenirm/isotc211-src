 ...
 */
public class MDGeometricObjectsPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDGeometricObjectsPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDGeometricObjectsPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDGeometricObjects()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDGEOMETRICOBJECTS$0) != 0;
        }
    }
     ...
     */
    public void unsetMDGeometricObjects()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDGEOMETRICOBJECTS$0, 0);
        }
    }
