 ...
 */
public class MDContentInformationPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDContentInformationPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDContentInformationPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractMDContentInformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTMDCONTENTINFORMATION$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractMDContentInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTMDCONTENTINFORMATION$1, 0);
        }
    }
