 ...
 */
public class MDDigitalTransferOptionsPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDDigitalTransferOptionsPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDDigitalTransferOptionsPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDDigitalTransferOptions()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDDIGITALTRANSFEROPTIONS$0) != 0;
        }
    }
     ...
     */
    public void unsetMDDigitalTransferOptions()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDDIGITALTRANSFEROPTIONS$0, 0);
        }
    }
