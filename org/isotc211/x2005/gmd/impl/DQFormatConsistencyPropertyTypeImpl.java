 ...
 */
public class DQFormatConsistencyPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.DQFormatConsistencyPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DQFormatConsistencyPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDQFormatConsistency()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DQFORMATCONSISTENCY$0) != 0;
        }
    }
     ...
     */
    public void unsetDQFormatConsistency()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DQFORMATCONSISTENCY$0, 0);
        }
    }
