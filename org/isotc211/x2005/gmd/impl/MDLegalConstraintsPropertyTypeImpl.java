 ...
 */
public class MDLegalConstraintsPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gmd.MDLegalConstraintsPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MDLegalConstraintsPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMDLegalConstraints()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MDLEGALCONSTRAINTS$0) != 0;
        }
    }
     ...
     */
    public void unsetMDLegalConstraints()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MDLEGALCONSTRAINTS$0, 0);
        }
    }
