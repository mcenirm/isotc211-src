 ...
 */
public class MultiplicityRangePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gco.MultiplicityRangePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MultiplicityRangePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMultiplicityRange()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MULTIPLICITYRANGE$0) != 0;
        }
    }
     ...
     */
    public void unsetMultiplicityRange()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MULTIPLICITYRANGE$0, 0);
        }
    }
