 ...
 */
public class ScopedNamePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gco.ScopedNamePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public ScopedNamePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetScopedName()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SCOPEDNAME$0) != 0;
        }
    }
     ...
     */
    public void unsetScopedName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(SCOPEDNAME$0, 0);
        }
    }
