 ...
 */
public class MultiplicityPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gco.MultiplicityPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MultiplicityPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMultiplicity()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MULTIPLICITY$0) != 0;
        }
    }
    ...
    public void unsetMultiplicity()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(MULTIPLICITY$0, 0);
        }
    }
