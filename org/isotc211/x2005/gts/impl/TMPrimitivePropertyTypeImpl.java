 ...
 */
public class TMPrimitivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.isotc211.x2005.gts.TMPrimitivePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TMPrimitivePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetAbstractTimePrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ABSTRACTTIMEPRIMITIVE$1) != 0;
        }
    }
     ...
     */
    public void unsetAbstractTimePrimitive()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ABSTRACTTIMEPRIMITIVE$1, 0);
        }
    }
